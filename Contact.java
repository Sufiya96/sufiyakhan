...
driver.findElement(By.xpath("//*[@placeholder='Username']")).sendKeys("soumya");
driver.findElement(By.cssSelector("input[placeholder='Email']")).sendKeys("Sk@gmail.com");
driver.findElement(By.cssSelector("input[type='tel']")).sendKeys("123456");
driver.findElement(By.xpath("//*[@name='message']")).sendKeys("abcd efgh ijkl");
